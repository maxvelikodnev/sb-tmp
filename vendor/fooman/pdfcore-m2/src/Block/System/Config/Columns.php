...
class Columns extends \Magento\Framework\View\Element\Html\Select
{
    ...
    public function getItemColumns()
    {
        $allColumns = [
            ...
            ['value' => 'nameAndSku', 'label' => __('Name + SKU')],
            ...
            ['value' => 'discountPercentage', 'label' => __('Discount Percentage')],
            ['value' => 'discountOriginalPercentage', 'label' => __('Discount Percentage (from Original)')],
