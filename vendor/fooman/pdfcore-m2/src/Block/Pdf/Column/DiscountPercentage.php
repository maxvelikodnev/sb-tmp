...
class DiscountPercentage extends \Fooman\PdfCore\Block\Pdf\Column implements \Fooman\PdfCore\Block\Pdf\ColumnInterface
{
    ...
    public function getDiscountPercent($row)
    {
        ...
        return $this->formatPercentage($orderItem->getDiscountPercent());
    }
